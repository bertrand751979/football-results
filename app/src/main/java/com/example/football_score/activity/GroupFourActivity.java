...
import static com.example.football_score.activity.MainActivity.MY_GROUP4_KEY;
...
public class GroupFourActivity extends AppCompatActivity {
    ...
    private ArrayList<Group> myListGroupFour=new ArrayList<>();
    ...
    private void addTeam(){
        if(nameOfGroup.getText().toString().equalsIgnoreCase("")){
            Toast.makeText(GroupFourActivity.this,"Veuillez saisir un nom de group",Toast.LENGTH_SHORT).show();
            return;
        }

        if(team1.getText().toString().equalsIgnoreCase("")){
            Toast.makeText(GroupFourActivity.this,"Veuillez saisir team 1",Toast.LENGTH_SHORT).show();
            return;
        }
        if(team2.getText().toString().equalsIgnoreCase("")){
            Toast.makeText(GroupFourActivity.this,"Veuillez saisir team 2",Toast.LENGTH_SHORT).show();
            return;
        }
        if(team3.getText().toString().equalsIgnoreCase("")){
            Toast.makeText(GroupFourActivity.this,"Veuillez saisir team 3",Toast.LENGTH_SHORT).show();
            return;
        }
        if(team4.getText().toString().equalsIgnoreCase("")){
            Toast.makeText(GroupFourActivity.this,"Veuillez saisir team 4",Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        myListGroupFour.add(group);
        SharedPreferencesManager.getInstance(this).saveGroups(myListGroupFour,MY_GROUP4_KEY);
        Toast.makeText(GroupFourActivity.this,"La taille est du groupe 4 est: "+myListGroupFour.size(),Toast.LENGTH_SHORT).show();
    }
}
