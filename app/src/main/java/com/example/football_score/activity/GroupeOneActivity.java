...
public class GroupeOneActivity extends AppCompatActivity {
    ...
    private void addTeam(){
        if(nameOfGroup.getText().toString().equalsIgnoreCase("")){
            Toast.makeText(GroupeOneActivity.this,"Veuillez saisir un nom de group",Toast.LENGTH_SHORT).show();
            return;
        }

        if(team1.getText().toString().equalsIgnoreCase("")){
            Toast.makeText(GroupeOneActivity.this,"Veuillez saisir team 1",Toast.LENGTH_SHORT).show();
            return;
        }
        if(team2.getText().toString().equalsIgnoreCase("")){
            Toast.makeText(GroupeOneActivity.this,"Veuillez saisir team 2",Toast.LENGTH_SHORT).show();
            return;
        }
        if(team3.getText().toString().equalsIgnoreCase("")){
            Toast.makeText(GroupeOneActivity.this,"Veuillez saisir team 3",Toast.LENGTH_SHORT).show();
            return;
        }
